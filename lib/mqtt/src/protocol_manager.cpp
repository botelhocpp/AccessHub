...
std::string shub::ProtocolManager::SerializeJson(std::string const& variable_name, uint32_t value) {
...
void shub::ProtocolManager::SubscribeTopic(std::string const& topic) {
    if(mqtt_client_.subscribe(topic.c_str())) {
...
void shub::ProtocolManager::SetCallback(protocol_callback_t callback) {
